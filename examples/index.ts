...
logger.adapter(logger.adapters.adapterStart, "127.0.0.1 HTTP GET /page {query: {}, header:{}, body:{}}", "NAME", "VALUE")
logger.adapter(logger.adapters.adapterEnd, "127.0.0.1 HTTP GET /page {query: {}, header:{'x-correlation':'0000','x-request':'0000'}, body:{'status': 'ok','message': 'Success','detail': 'Dummy message'}}", "NAME", "VALUE")
